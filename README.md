...
- `MODEL_COMPLETION`: The model to use just for generating the responses, e.g. `meta-llama/Meta-Llama-3.1-8B-Instruct`, `gpt-4o`, `llama3.1`. If not provided, it will default to `MODEL` 
